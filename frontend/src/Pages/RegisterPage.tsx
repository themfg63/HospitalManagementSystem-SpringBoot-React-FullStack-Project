            ...
            <div className="w-[450px] backdrop-blur-md p-10 py-8 rounded-lg">
                <form onSubmit={form.onSubmit(handleSubmit)} className="flex flex-col gap-5 [&_input]:placeholder-natural-100 [&_.mantine-Input-input]:!border-white focus-within:[&_.mantine-Input-input]:!border-pink-400 [&_.mantine-Input-input]:!border [&_input]:!pl-2 [&_svg]:text-white [&_input]:!text-white">
                    ...
                    <SegmentedControl
                        ...
                        data={[{label:"Hasta",value:"PATIENT"},{label:"Doktor",value:"DOCTOR"},{label:"Yönetici",value:"ADMIN"}]}
                    />
                    <TextInput
                    ...
                    />
                    <Button radius="md" size="md" type="submit" color="pink">Hesap Oluştur</Button>
                    <div className="text-natural-100 text-sm self-center">Hesabınız var mı? <Link to="/login" className="hover:underline">Giriş Yap</Link></div>
                </form>
            </div>
        </div>
    )
